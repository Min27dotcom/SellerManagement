...
const modalOverlayAvatar = document.querySelector(".modal__overlay-avatar");
const btnCloseChange = document.querySelector(".btn-close-change-avatar");
const btnChangeAvatar = document.querySelector(".change-avatar-btn");

function toggleModalChangeAvatarForm() {
    modalChangeAvatar.classList.toggle('show');
}

btnChangeAvatar.addEventListener('click', toggleModalChangeAvatarForm);
modalOverlayAvatar.addEventListener('click', toggleModalChangeAvatarForm);
btnCloseChange.addEventListener('click', toggleModalChangeAvatarForm);

modalChangeAvatar.addEventListener('click', function (event) {
...
const adminAccLink = document.querySelector(".header__navbar-user-item-link");
const btnCloseAdminDetailModal = document.querySelector(".btn-close.btn-close-detail-admin");

function toggleAdminModalDetailsForm() {
    modalDetailAdminAcc.classList.toggle('show');
}
adminAccLink.addEventListener("click", (e) => {
    e.preventDefault();
    toggleAdminModalDetailsForm();
})
modalOverlayAdminDetail.addEventListener('click', toggleAdminModalDetailsForm);
btnCloseAdminDetailModal.addEventListener('click', toggleAdminModalDetailsForm);

modalDetailAdminAcc.addEventListener('click', function (event) {
    event.stopPropagation()
})
